        ...
        <section className="grid gap-7">
          <div className="grid gap-4">
            <p className="m-0 flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.22em] text-[var(--primary)]">
              <Sparkles aria-hidden="true" className="size-4" /> Private-club
              feel, open play
            </p>
            ...
            <p className="m-0 max-w-xl text-lg leading-8 text-[var(--muted)]">
              Take a seat at a refined live table, play with free points, and
              let the server keep every hand fair and in sync.
            </p>
          </div>
          <ul className="m-0 grid max-w-2xl list-none gap-3 p-0 sm:grid-cols-2">
            <li className="flex items-center gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-4">
              ...
              />
              <span>
                <strong className="block">2–9 seats</strong>
                <span className="text-sm text-[var(--muted)]">
                  Responsive live tables
                </span>
              </span>
            </li>
            <li className="flex items-center gap-3 rounded-xl border border-[var(--border)] bg-[var(--surface)] p-4">
              ...
              />
              <span>
                <strong className="block">Authoritative play</strong>
                <span className="text-sm text-[var(--muted)]">
                  Reliable actions and balances
                </span>
              </span>
            </li>
          </ul>
